...
<div className="border border-dashed rounded-lg border-gray-500  w-full h-[150px] relative ">
    <input onChange={onFileChange}    type="file" multiple={false} accept="image/jpeg,image/png,image/gif" className="relative cursor-pointer  block opacity-0 w-full h-full z-50"/>
